...
{
	// Token: 0x06004AD4 RID: 19156 RVA: 0x00160FDC File Offset: 0x0015F1DC
	...
	// Token: 0x06004AD5 RID: 19157 RVA: 0x001610EC File Offset: 0x0015F2EC
	public static Mesh GenerateMeshFromSubMesh(this Mesh sourceMesh, int subMeshIndex)
	{
		...
		{
			Debug.LogError(string.Format("Submesh index {0} is out of range for the specified mesh.", subMeshIndex));
			return null;
		}
		Mesh mesh = new Mesh();
		...
		{
			int count;
			if (!dictionary.TryGetValue(num, out count))
			{
				count = list.Count;
	...
	// Token: 0x06004AD6 RID: 19158 RVA: 0x00161244 File Offset: 0x0015F444
